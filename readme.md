...
- remote_audio_output - project, used to transmit soundt over the LAN
...
- download ffmpeg's shared and dev packages from https://ffmpeg.zeranoe.com/builds 
- extract dev package into ./externals/3rdparty/ffmpeg
- extract dll's from shared package to ./bin
<br> <br>
- pray to your deity
- build it!
